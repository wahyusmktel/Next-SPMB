                        ...
                        <Card variant="elevated">
                            ...
                            <CardContent className="space-y-4">
                                <div className="flex items-center gap-4 mb-6">
                                    ...
                                    <div>
                                        <h4 className="font-semibold text-gray-900">{user?.name || "Super Admin"}</h4>
                                        <p className="text-sm text-gray-500">{user?.email || "superadmin@spmb.id"}</p>
                                        <Badge variant="info" size="sm" className="mt-1">Super Admin</Badge>
                                    </div>
                                </div>

                                <div className="grid md:grid-cols-2 gap-4">
                                    <Input label="Nama Lengkap" defaultValue={user?.name || "Super Admin"} />
                                    <Input label="Email" type="email" defaultValue={user?.email || "superadmin@spmb.id"} />
                    ...
                    >
                        <Card variant="elevated">
                            ...
                            <CardContent>
                                <div className="space-y-4">
                                    {[
                                        { label: "Notifikasi Email", desc: "Terima notifikasi via email", icon: Mail },
                                        { label: "Notifikasi Push", desc: "Terima notifikasi browser", icon: Bell },
                                        { label: "Notifikasi SMS", desc: "Terima notifikasi via SMS", icon: Smartphone },
                                    ].map((item) => (
