...
from app.api import sekolah, auth, siswa, dinas, config, common, pendaftaran, upload
...
# api_router.include_router(user.router, prefix="/users", tags=["users"])  # To be added
# api_router.include_router(pendaftaran.router, prefix="/pendaftaran", tags=["pendaftaran"]) # To be added
